 ...
 * wrong number to show a learner: nine official rows are same-level homographs that collapse
 * into one card each (爸爸|爸), so a level ships a word or two fewer than the standard lists.
 *
...
export const SHIPPED_SIZES: Record<Level, number> = { 1: 500, 2: 769, 3: 969, 4: 999, 5: 1070 };
